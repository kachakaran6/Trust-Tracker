...
function Budget() {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="text-sm">
              <span className="font-semibold text-gray-700">
                {formatPercentage(currentMonthSummary.percentage)}
              </span>{" "}
              used
            </div>
      ...
      {/* Budget tips */}
      <div
        className="card p-6 bg-primary-50 border border-primary-100 animate-slide-up"
      ...
      >
        ...
        <ul className="space-y-2 text-sm">
          <li className="flex items-start">
            ...
            <span>
              Set realistic budget goals based on your historical spending
              patterns.
            </span>
          </li>
          <li className="flex items-start">
            <Check size={16} className="text-primary-600 mr-2 mt-0.5" />
            <span>
              Try the 50/30/20 rule: Spend 50% on needs, 30% on wants, and save
              20%.
            </span>
          </li>
          <li className="flex items-start">
            <Check size={16} className="text-primary-600 mr-2 mt-0.5" />
            <span>
              Review and adjust your budgets regularly as your financial
              situation changes.
            </span>
          </li>
          <li className="flex items-start">
            <Check size={16} className="text-primary-600 mr-2 mt-0.5" />
            <span>
              Plan for irregular expenses like holidays, vacations, and annual
              subscriptions.
            </span>
          </li>
        </ul>
