...
import { ArrowUpRight, ArrowDownRight, DollarSign, Wallet, TrendingUp, AlertTriangle } from 'lucide-react';
        ...
        <div className="card p-6 animate-fade-in">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{formatCurrency(currentMonthSummary.totalIncome)}</p>
            </div>
        ...
        <div className="card p-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{formatCurrency(currentMonthSummary.totalExpense)}</p>
            </div>
        ...
        <div className="card p-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{formatCurrency(currentMonthSummary.balance)}</p>
            </div>
        ...
        <div className="card p-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{Math.round(budgetSummary.percentage)}%</p>
            </div>
          ...
          <div className="mt-4 bg-gray-200 h-2 rounded-full overflow-hidden">
            <div 
              className={`h-full rounded-full ${
                budgetSummary.percentage > 90 ? 'bg-danger-500' : 
                budgetSummary.percentage > 75 ? 'bg-warning-500' : 
                'bg-success-500'
              }`}
                ...
                <div key={transaction.id} className="p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <p className="text-xs text-gray-500">{transaction.category} • {format(parseISO(transaction.date), 'MMM d, yyyy')}</p>
                    </div>
      ...
      <div className="card p-6 animate-slide-up" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            ...
            <p className="text-sm text-gray-600">Based on your historical data, we predict your expenses will likely be $3,240 next month.</p>
          </div>
          ...
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
            ...
            <p className="text-sm text-gray-600">You're approaching your Entertainment budget limit. Consider reducing spending in this category.</p>
          </div>
        </div>
      </div>
    </div>
