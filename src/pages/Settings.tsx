...
import { User, Shield, Bell, HelpCircle, Edit2, Trash2, Save } from 'lucide-react';
        ...
        return (
          <div className="animate-fade-in">
            ...
            <div className="card p-6">
              <h3 className="font-semibold text-danger-600 mb-4">Danger Zone</h3>
              <div className="border border-danger-200 rounded-lg p-4 bg-danger-50">
                ...
                <p className="text-sm text-danger-700 mb-4">
                  Once you delete your account, there is no going back. This action cannot be undone and will permanently delete all your financial data.
                </p>
                <button 
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-3">
                  Income Categories ({categories.filter(cat => cat.type === 'income').length})
                </h3>
                <div className="grid gap-3">
                  {categories
                    .filter(cat => cat.type === 'income')
                    .map(category => (
                      <div key={category.id} className="card p-4 flex items-center justify-between hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-3">
                  Expense Categories ({categories.filter(cat => cat.type === 'expense').length})
                </h3>
                <div className="grid gap-3">
                  {categories
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">Get notified when you're approaching or exceeding budget limits</p>
                  </div>
                  <div className="ml-4">
                    <button
                      type="button"
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${
                        notificationSettings.budgetAlerts ? 'bg-primary-600' : 'bg-gray-200'
                      }`}
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">Receive a summary of your financial activity each week</p>
                  </div>
                  <div className="ml-4">
                    <button
                      type="button"
                ...
                <div className="flex items-center justify-between py-4">
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Savings Tips & Insights</h3>
                    <p className="text-sm text-gray-500">Get personalized recommendations for saving money and improving your finances</p>
                  </div>
                  <div className="ml-4">
                    <button
                      type="button"
                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${
                        notificationSettings.savingsTips ? 'bg-primary-600' : 'bg-gray-200'
                      }`}
                      onClick={() => handleNotificationToggle('savingsTips')}
                    >
                      <span
                        className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                          notificationSettings.savingsTips ? 'translate-x-5' : 'translate-x-0'
                        }`}
                      />
                    </button>
                  </div>
              ...
              <div className="space-y-4">
                <details className="group">
                  <summary className="flex items-center justify-between w-full text-left font-medium py-2 cursor-pointer focus:outline-none">
                    ...
                    <span className="ml-6 h-7 flex items-center group-open:rotate-45 transition-transform">+</span>
                  </summary>
                  <div className="mt-2 text-sm text-gray-600 pl-4 border-l-2 border-primary-100">
                    <p>
                      Our AI-powered prediction feature analyzes your historical spending patterns using machine learning algorithms to forecast future expenses. The system considers factors like seasonal trends, recurring payments, and spending habits to provide increasingly accurate predictions as it learns from your financial behavior over time.
                    </p>
                  </div>
                </details>
                ...
                <details className="group border-t border-gray-200 pt-4">
                  ...
                  <div className="mt-2 text-sm text-gray-600 pl-4 border-l-2 border-primary-100">
                    <p>
                      Yes, your financial data is protected with bank-level security. We use end-to-end encryption, secure cloud storage, and never share your personal financial information with third parties. All data is stored in compliance with financial privacy regulations.
                    </p>
                  </div>
                </details>
                ...
                <details className="group border-t border-gray-200 pt-4">
                  ...
                  <div className="mt-2 text-sm text-gray-600 pl-4 border-l-2 border-primary-100">
                    <p>
                      You can export your data from the Settings page. We support CSV and PDF formats for transactions, budgets, and reports. This feature is useful for tax preparation or switching to another financial management tool.
                    </p>
                  </div>
                </details>
                ...
                <details className="group border-t border-gray-200 pt-4">
                  <summary className="flex items-center justify-between w-full text-left font-medium py-2 cursor-pointer focus:outline-none">
                    <span>Can I connect my bank account for automatic transaction import?</span>
                    <span className="ml-6 h-7 flex items-center group-open:rotate-45 transition-transform">+</span>
                  </summary>
                  <div className="mt-2 text-sm text-gray-600 pl-4 border-l-2 border-primary-100">
                    <p>
                      Bank account integration is coming soon! Currently, you can manually add transactions or import them via CSV. We're working on secure bank connections to automatically sync your transactions while maintaining the highest security standards.
                    </p>
                  </div>
                </details>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="card p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Need help with something not covered in the FAQs? Our support team is ready to assist you.
                </p>
                <div className="space-y-2">
                  <a href="mailto:support@finsight.com" className="btn-primary inline-block w-full text-center">
                    Email Support
                  </a>
